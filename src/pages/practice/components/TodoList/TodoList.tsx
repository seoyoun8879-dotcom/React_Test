  ...
  return (
    ...
    >
      ...
      <div className={style["select-box"]}>
        ...
        >
          <li className={style.item} onClick={() => handleSelectItemPut("상")}>
            상
          </li>
          <li className={style.item} onClick={() => handleSelectItemPut("중")}>
            중
          </li>
          <li className={style.item} onClick={() => handleSelectItemPut("하")}>
            하
          </li>
        </ul>
      </div>
